...
ActiveRecord::Schema.define(version: 2018_06_29_051921) do
  ...
  create_table "user_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "dashboard_slug"
    t.index ["dashboard_slug"], name: "index_user_profiles_on_dashboard_slug", unique: true
